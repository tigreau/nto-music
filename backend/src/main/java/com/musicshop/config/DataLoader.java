...
public class DataLoader implements CommandLineRunner {
        ...
        private void seedCategories() {
                ...
                // Guitars & Plucked
                Category guitars = createCategory("Guitars & Plucked", "guitars-and-plucked", null);
                createCategory("Electric Guitar", "electric-guitar", guitars);
                createCategory("Acoustic Guitar", "acoustic-guitar", guitars);
                createCategory("Bass Guitar", "bass-guitar", guitars);
                createCategory("Ukulele", "ukulele", guitars);
                createCategory("Banjo", "banjo", guitars);
                createCategory("Mandolin", "mandolin", guitars);

                // Drums & Percussion
                Category drums = createCategory("Drums & Percussion", "drums-and-percussion", null);
                createCategory("Drum Kit", "drum-kit", drums);
                createCategory("Cymbal", "cymbal", drums);
                createCategory("Cajon", "cajon", drums);
                createCategory("Drum Machine", "drum-machine", drums);
                createCategory("Xylophone", "xylophone", drums);

                // Keys & Synths
                Category keys = createCategory("Keys & Synths", "keys-and-synths", null);
                createCategory("Piano", "piano", keys);
                createCategory("Organ", "organ", keys);
                createCategory("Accordion", "accordion", keys);
                createCategory("Synthesizer", "synthesizer", keys);
                createCategory("Sampler", "sampler", keys);

                // Wind & Brass
                Category wind = createCategory("Wind & Brass", "wind-and-brass", null);
                createCategory("Saxophone", "saxophone", wind);
                createCategory("Trumpet", "trumpet", wind);
                createCategory("Flute", "flute", wind);
                createCategory("Harmonica", "harmonica", wind);
                createCategory("Bagpipe", "bagpipe", wind);
                createCategory("Kazoo", "kazoo", wind);

                // Bowed Strings
                Category strings = createCategory("Bowed Strings", "bowed-strings", null);
                createCategory("Violin", "violin", strings);
                createCategory("Viola", "viola", strings);
                createCategory("Cello", "cello", strings);
                createCategory("Double Bass", "double-bass", strings);
                createCategory("Electric Violin", "electric-violin", strings);
        }
        ...
        private Product createProduct(String name, String description, BigDecimal price,
                ...
                try {
                        ...
                        System.out.println("Skipping duplicate product slug: " + p.getSlug());
                        return null;
                }
        }

        private void seedReviews(User user) {
